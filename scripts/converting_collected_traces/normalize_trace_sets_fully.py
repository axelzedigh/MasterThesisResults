...
from utils.db_utils import get_training_trace_path__combined_200k_data, \
    get_test_trace_path, get_training_trace_path__combined_100k_data, \
...
def normalize_test_traces__trace_process_4(
    ...
    # Store new trace set
    save_path = os.path.join(
        test_trace_set_path, "trace_process_4__sbox_range_204_314.npy"
    )
...
def normalize_training_traces__trace_process_9_10(
    ...
    if trace_process_id == 9:
        ...
        training_save_path = os.path.join(
            training_dataset_path, "trace_process_10-maxmin_[-1_1]_[204_314].npy"
        )
    else:
