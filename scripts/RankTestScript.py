...
def test(model_path, interest_byte, device_nr):
    ...
    TRACES = os.path.join(FULL_PATH, NOR_TRACES_MAXMIN)
    KEYS = os.path.join(FULL_PATH, TENTH_ROUNDKEY)
    CIPHERTEXTS = os.path.join(FULL_PATH, CT)
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(0, RUNS)):
        termination_point_array.append(test(FILE_PATH, KEY_BYTE, DEVICE))
        # print(termination_point_array)
        np.save(
